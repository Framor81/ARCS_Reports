...
- They trained a neural network for depth estimation using the images of each database and test them on real images.They then perform scene classification on randomly picked images and report the tnropy of the distribution of top-1 classes for each env.
